    ...
    {isMobile ? <div className={`z-50 lg:hidden w-screen h-screen bg-modal fixed top-0 left-0 ${customClass}`}>
      ...
      <div ref={optionRef} className={`z-50 hidden lg:flex w-[381px] text-black  flex-col bg-white border border-solid border-secondary_fill option_box_shadow rounded-12t ${customClass}`}>
        <div className='m-16t'>
          ...
          <div className='flex mb-16t items-baseline'>
            <div className='basis-7/12 mr-8t h-40t'>
              <Input customInputClass='text-input_placeholder' value={url} isDisabled={true} label='' placeholder={url} handleChange={function (e: any): void {
          ...
          <div className='flex justify-center'> 
            <Button myClass='text-danger mx-16t' handleClick={() => openDeleteModal()} type='third' size=''>
