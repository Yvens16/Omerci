...
// import GifyIcon from "../../create_msg/media_search/gifyLogo.svg"
// import IAddNewMessage from '../interfaces';

function AddNewMessage({goToCreateMessage}: {goToCreateMessage: () => void}) {
  return <div className={`lg:w-[417px] flex flex-col text-center border border-dashed border-dashed_third rounded-12t h-max p-48t`}>
