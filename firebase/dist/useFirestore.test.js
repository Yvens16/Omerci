...
var useFirestore_1 = require("./useFirestore");
...
//   })
// });
test('test firebase emulator', function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, waitForNextUpdate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = react_hooks_1.renderHook(function () { return useFirestore_1["default"](); }), result = _a.result, waitForNextUpdate = _a.waitForNextUpdate;
                return [4 /*yield*/, waitForNextUpdate()];
            case 1:
                _b.sent();
                react_hooks_1.act(function () {
                    result.current.addUserInfo({ uid: "uid", firstName: "firstName", lastName: "lastName", howDoYouKnowUs: "howDoYouKnowUs", email: "email" });
                });
                return [2 /*return*/];
        }
    });
